...
forking the renderer, and because it composes rather than replaces, a policy that only strips
attributes cannot accidentally re-admit `\href{javascript:…}`. Nothing changes by default.
